...
import 'package:github_aoi/providers/repo_provider.dart';
import 'package:github_aoi/screens/info_screen.dart';
...
class _RepositiriesScreenState extends State<RepositiriesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.username ?? 'None'),
                      ...
                      Container(
                          ...
                          child: Padding(
                            ...
                            child: Align(
                                ...
                                child:
                                    Text(repoData.repoList[index].repo_name ?? 'None'),
                                    ),
                          )),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
                          children:[
                            ...
                            Text(dateF.format(DateTime.parse(
                                repoData.repoList[index].created_date)) ?? 'None')
                          ],
                        ),
                      ),
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                      width: 150,
                                      child: Text(
                                          repoData.repoList[index].description ?? 'None'))
                                ],
                              ),
                            ),
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Text(dateF.format(DateTime.parse(
                                repoData.repoList[index].last_pushed)) ?? 'None')
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Text(repoData.repoList[index].branch ?? 'None')
                          ],
                        ),
                      ),
                      Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Text(
                                    'Stars: ${repoData.repoList[index].stars.toString()}' ?? 'None'),
                                Text(repoData.repoList[index].language ?? 'None'),
                              ],
                            ),
                          )),
                      //  Text('${url}')
